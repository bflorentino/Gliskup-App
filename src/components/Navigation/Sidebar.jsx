...
const Sidebar = () => {
  ...
  return (
    <aside className='flex flex-col bg-auth-primary mt-[90px] w-[20%] h-4/5 ml-4 rounded-xl'>
      <div className=' h-[70px] rounded-t bg-transparent' >
        <div className='flex justify-center '>
          <img src={`${userOnline.profilePic}`} alt="Me" className='w-20 h-20 rounded-full mt-6 border-4 border-green-user' />
        </div>
      </div>
      ...
      <div>
        ...
        <div className='flex mt-2 justify-center text-gray-text'>
          <p className='flex flex-col border-r ml-2 px-2'><span className='text-center'>100</span> posts</p>
          <p className='flex flex-col border-r ml-2 px-2'><span className='text-center'>100</span> followers</p>
          <p className='flex flex-col ml-2 px-1'><span className='text-center'>100</span > following</p>
        </div>
